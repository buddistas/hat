...
- **Статистика игровой сессии**: Детальная статистика прошедшей партии (время игры, интересные факты, статистика по словам)
...
- **Статистика сессии**: Локальная система сбора данных в браузере (независимо от сервера)
...
- **[SESSION_STATS_SCREEN.md](SESSION_STATS_SCREEN.md)** - Документация по экрану статистики игровой сессии
