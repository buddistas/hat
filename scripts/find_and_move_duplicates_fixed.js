 ...
 * ИСПРАВЛЕННАЯ ВЕРСИЯ с правильным алгоритмом нормализации
 * 
...
/**
 * ИСПРАВЛЕННАЯ нормализация слова для поиска дубликатов
 * Более точный и консервативный подход
 */
function normalizeWord(word) {
  ...
  // Консервативная лемматизация - только для очевидных дубликатов
